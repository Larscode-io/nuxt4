...
export default defineEventHandler(async (event) => {
  ...
  // it is cleaner to receive the query parameters as an object in the body like this:
  ...
  // and we parse them here by replacing nuxt/nl/auth/callback by /nuxt/api/tok in the browser url
