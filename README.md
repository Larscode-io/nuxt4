...
- **API's**
  ...
  - [X] Demo: [Basic CSAM login page](./app/pages/auth/login.vue), first [create]([create a light profile](https://iamapps.int.belgium.be/sma/generalinfo?redirectUrl=/sma/) a test profile with Belgian **eID** card.
