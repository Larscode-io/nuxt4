<template>
    <div class="judgment-card">
        ...
        <h3 class="mt-4">
            <a :href="pdfUrlWithSearch" class="mr-2" rel="noopener noreferrer" target="_blank">
                <v-icon size="36" color="red" left>
                    mdi-file-pdf-box
                </v-icon>
            </a>
        ...
        <span class="subtitle my-2" v-html="description || t('error.noDataAvailable')" />
    </div>
</template>
