...
const validateForm = (): boolean => {
  ...
  //   if (!payload.applicantTypes.length) {
  //     errors.value.applicantTypes.push(t("validation.required") || "This field is required");
  //   }
  //   if (!payload.applicant) {
  //     errors.value.applicant.push(t("validation.required") || "This field is required");
  //   }
  // }
  // if (isSearchJudgmentsTypeJurisdiction.value) {
  //   if (!payload.jurisdiction) {
  //     errors.value.jurisdiction.push(t("validation.required") || "This field is required");
  //   }
  //   if (!payload.jurisdictionArea) {
  //     errors.value.jurisdictionArea.push(t("validation.required") || "This field is required");
  //   }
  //   if (!payload.referralDecisionDates[0]) {
  //     errors.value.referralDecisionDates[0] = t("validation.required") || "This field is required";
  //   }
  //   if (!payload.referralDecisionDates[1]) {
  //     errors.value.referralDecisionDates[1] = t("validation.required") || "This field is required";
  //   }
  // }
  // if (!payload.judgmentNumber) {
  //   errors.value.judgmentNumber.push(t("validation.required") || "This field is required");
  // }
  // if (isSearchJudgmentsTypeRollNumber.value && !payload.rollNumber) {
  //   errors.value.rollNumber.push(t("validation.required") || "This field is required");
  // }
  // if (!payload.judgmentDates[0]) {
  //   errors.value.judgmentDates[0] = t("validation.required") || "This field is required";
  // }
  // if (!payload.judgmentDates[1]) {
  //   errors.value.judgmentDates[1] = t("validation.required") || "This field is required";
  // }
  // if (!payload.judgmentTypes.length) {
  //   errors.value.judgmentTypes.push(t("validation.required") || "This field is required");
  // }
  // if (isSearchJudgmentsTypeRollNumber.value) {
  //   if (!payload.beOfficialJournalDates[0]) {
  //     errors.value.beOfficialJournalDates[0] = t("validation.required") || "This field is required";
  //   }
  //   if (!payload.beOfficialJournalDates[1]) {
  //     errors.value.beOfficialJournalDates[1] = t("validation.required") || "This field is required";
  //   }
  // }
